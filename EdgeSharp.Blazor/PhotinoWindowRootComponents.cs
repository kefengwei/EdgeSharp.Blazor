...
namespace EdgeSharp.Blazor
{
    ...
    {
        private readonly EdgeSharpWebViewManager _manager;

        internal BlazorWindowRootComponents(EdgeSharpWebViewManager manager, JSComponentConfigurationStore jsComponents)
        {
            _manager = manager;
