...
namespace EdgeSharp.Blazor
{
    ...
    internal class EdgeSharpSyncrhronizationContext : SynchronizationContext
    {
        ...
        {
            var completion = new EdgeSharpSynchronizationTaskCompletionSource<Action, object>(action);
            ExecuteSynchronouslyIfPossible((state) =>
            {
                var completion = (EdgeSharpSynchronizationTaskCompletionSource<Action, object>)state;
                try
                {
                    completion.Callback();
        ...
        {
            var completion = new EdgeSharpSynchronizationTaskCompletionSource<Func<Task>, object>(asyncAction);
            ExecuteSynchronouslyIfPossible(async (state) =>
            {
                var completion = (EdgeSharpSynchronizationTaskCompletionSource<Func<Task>, object>)state;
                try
                {
        ...
        {
            var completion = new EdgeSharpSynchronizationTaskCompletionSource<Func<TResult>, TResult>(function);
            ExecuteSynchronouslyIfPossible((state) =>
            {
                var completion = (EdgeSharpSynchronizationTaskCompletionSource<Func<TResult>, TResult>)state;
                try
                {
        ...
        {
            var completion = new EdgeSharpSynchronizationTaskCompletionSource<Func<Task<TResult>>, TResult>(asyncFunction);
            ExecuteSynchronouslyIfPossible(async (state) =>
            {
                var completion = (EdgeSharpSynchronizationTaskCompletionSource<Func<Task<TResult>>, TResult>)state;
                try
                {
        ...
        {
            return new EdgeSharpSyncrhronizationContext();
        }
            ...
            object state)
        {
            ...
            // 使用浏览器线程进行分发
            EdgeSharp.Core.Infrastructure.Dispatcher.Browser.Post(() =>
            {
        ...
        {
            public EdgeSharpSyncrhronizationContext SynchronizationContext;
            public ExecutionContext ExecutionContext;
            public SendOrPostCallback Callback;
            public object State;
        }

        private class EdgeSharpSynchronizationTaskCompletionSource<TCallback, TResult> : TaskCompletionSource<TResult>
        {
            public EdgeSharpSynchronizationTaskCompletionSource(TCallback callback)
            {
                Callback = callback;
            }
